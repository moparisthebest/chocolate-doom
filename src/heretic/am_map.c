...
static byte antialias[NUMALIAS][8] = {{96, 97, 98, 99, 100, 101, 102, 103},
...
static short mapystart =
    0; // y-value for the start of the map bitmap...used in the paralax stuff.
...
void AM_drawPlayers(void) {
  ...
  if (!netgame) {
    /*
       if (cheating) AM_drawLineCharacter(cheat_player_arrow, NUMCHEATPLYRLINES,
       0, plr->mo->angle, WHITE, plr->mo->x, plr->mo->y);
