...
state_t states[NUMSTATES] = {
    ...
    {SPR_ACLO, 0, 4, A_RestoreSpecialThing1, S_HIDESPECIAL3, 0,
     0},                                                     // S_HIDESPECIAL2
    ...
    {SPR_XPL1, 0, 4, A_VolcBallImpact, S_VOLCANOBALLX2, 0,
     0},                                            // S_VOLCANOBALLX1
    ...
    {SPR_TGLT, 0, 8, A_SpawnTeleGlitter, S_TELEGLITGEN1, 0,
     0}, // S_TELEGLITGEN1
    {SPR_TGLT, 5, 8, A_SpawnTeleGlitter2, S_TELEGLITGEN2, 0,
     0},                                                // S_TELEGLITGEN2
    {SPR_TGLT, 32768, 2, NULL, S_TELEGLITTER1_2, 0, 0}, // S_TELEGLITTER1_1
    {SPR_TGLT, 32769, 2, A_AccTeleGlitter, S_TELEGLITTER1_3, 0,
     0},                                                // S_TELEGLITTER1_2
    {SPR_TGLT, 32770, 2, NULL, S_TELEGLITTER1_4, 0, 0}, // S_TELEGLITTER1_3
    {SPR_TGLT, 32771, 2, A_AccTeleGlitter, S_TELEGLITTER1_5, 0,
     0},                                                // S_TELEGLITTER1_4
    {SPR_TGLT, 32772, 2, NULL, S_TELEGLITTER1_1, 0, 0}, // S_TELEGLITTER1_5
    {SPR_TGLT, 32773, 2, NULL, S_TELEGLITTER2_2, 0, 0}, // S_TELEGLITTER2_1
    {SPR_TGLT, 32774, 2, A_AccTeleGlitter, S_TELEGLITTER2_3, 0,
     0},                                                // S_TELEGLITTER2_2
    {SPR_TGLT, 32775, 2, NULL, S_TELEGLITTER2_4, 0, 0}, // S_TELEGLITTER2_3
    {SPR_TGLT, 32776, 2, A_AccTeleGlitter, S_TELEGLITTER2_5, 0,
     0},                                                     // S_TELEGLITTER2_4
    ...
    {SPR_GAUN, 6, 4, A_WeaponReady, S_GAUNTLETREADY2_2, 0,
     0}, // S_GAUNTLETREADY2_1
    {SPR_GAUN, 7, 4, A_WeaponReady, S_GAUNTLETREADY2_3, 0,
     0}, // S_GAUNTLETREADY2_2
    {SPR_GAUN, 8, 4, A_WeaponReady, S_GAUNTLETREADY2_1, 0,
     0},                                              // S_GAUNTLETREADY2_3
    ...
    {SPR_GAUN, 32771, 4, A_GauntletAttack, S_GAUNTLETATK1_4, 0,
     0}, // S_GAUNTLETATK1_3
    {SPR_GAUN, 32772, 4, A_GauntletAttack, S_GAUNTLETATK1_5, 0,
     0}, // S_GAUNTLETATK1_4
    {SPR_GAUN, 32773, 4, A_GauntletAttack, S_GAUNTLETATK1_6, 0,
     0},                                                // S_GAUNTLETATK1_5
    ...
    {SPR_GAUN, 32779, 4, A_GauntletAttack, S_GAUNTLETATK2_4, 0,
     0}, // S_GAUNTLETATK2_3
    {SPR_GAUN, 32780, 4, A_GauntletAttack, S_GAUNTLETATK2_5, 0,
     0}, // S_GAUNTLETATK2_4
    {SPR_GAUN, 32781, 4, A_GauntletAttack, S_GAUNTLETATK2_6, 0,
     0},                                                   // S_GAUNTLETATK2_5
    ...
    {SPR_BLSR, 3, 2, A_FireBlasterPL1, S_BLASTERATK1_4, 0,
     0},                                              // S_BLASTERATK1_3
    ...
    {SPR_BLSR, 3, 3, A_FireBlasterPL2, S_BLASTERATK2_4, 0,
     0},                                              // S_BLASTERATK2_3
    ...
    {SPR_FX18, 32768, 3, A_SpawnRippers, S_BLASTERFXI1_2, 0,
     0},                                                 // S_BLASTERFXI1_1
    ...
    {SPR_HROD, 0, 4, A_FireSkullRodPL1, S_HORNRODATK1_2, 0,
     0}, // S_HORNRODATK1_1
    {SPR_HROD, 1, 4, A_FireSkullRodPL1, S_HORNRODATK1_3, 0,
     0},                                              // S_HORNRODATK1_2
    ...
    {SPR_HROD, 6, 4, A_FireSkullRodPL2, S_HORNRODATK2_6, 0,
     0},                                              // S_HORNRODATK2_5
    ...
    {SPR_GWND, 2, 5, A_FireGoldWandPL1, S_GOLDWANDATK1_3, 0,
     0},                                               // S_GOLDWANDATK1_2
    ...
    {SPR_GWND, 2, 4, A_FireGoldWandPL2, S_GOLDWANDATK2_3, 0,
     0},                                                   // S_GOLDWANDATK2_2
    ...
    {SPR_PHNX, 2, 7, A_FirePhoenixPL1, S_PHOENIXATK1_3, 0,
     0},                                              // S_PHOENIXATK1_2
    ...
    {SPR_PHNX, 1, 3, A_InitPhoenixPL2, S_PHOENIXATK2_2, 0,
     0}, // S_PHOENIXATK2_1
    {SPR_PHNX, 32770, 1, A_FirePhoenixPL2, S_PHOENIXATK2_3, 0,
     0},                                               // S_PHOENIXATK2_2
    {SPR_PHNX, 1, 4, A_ReFire, S_PHOENIXATK2_4, 0, 0}, // S_PHOENIXATK2_3
    {SPR_PHNX, 1, 4, A_ShutdownPhoenixPL2, S_PHOENIXREADY, 0,
     0}, // S_PHOENIXATK2_4
    ...
    {SPR_FX08, 32777, 8, A_RemovedPhoenixFunc, S_PHOENIXFXIX_2, 0,
     0},                                                      // S_PHOENIXFXIX_2
    ...
    {SPR_BSKL, 5, 16, A_CheckSkullDone, S_BLOODYSKULLX1, 0,
     0},                                                     // S_BLOODYSKULLX1
