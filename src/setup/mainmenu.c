...
static void QuitConfirm(void *unused1, void *unused2) {
  ...
  TXT_AddWidgets(window, label = TXT_NewLabel("Exiting setup.\nSave settings?"),
                 TXT_NewStrut(24, 0),
...
void MainMenu(void) {
  ...
  TXT_AddWidgets(
      ...
      TXT_NewButton2("Configure Keyboard", (TxtWidgetSignalFunc)ConfigKeyboard,
                     NULL),
      ...
      TXT_NewButton2("Join a Network Game", (TxtWidgetSignalFunc)JoinMultiGame,
                     NULL),
...
static void SetIcon(void) {
  ...
  surface = SDL_CreateRGBSurfaceFrom(
      (void *)setup_icon_data, setup_icon_w, setup_icon_h, 32, setup_icon_w * 4,
