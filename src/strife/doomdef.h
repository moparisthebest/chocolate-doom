...
// villsa [STRIFE]
// quest numbers
typedef enum { // Hex          Watcom Name               player_t offset
...
enum { //  Name       Flag from bitnum      Purpose, if known
  ...
  QF_QUEST27 =
      (1 << tk_quest27), // Destroyed the Computer (checked for good ending)
  QF_QUEST28 =
      (1 << tk_quest28), // Obtained Catacomb Key (checked by line type 228)
  QF_QUEST29 = (1 << tk_quest29), // Destroyed the Mines Transmitter
  QF_QUEST30 = (1 << tk_quest30),
  QF_QUEST31 = (1 << tk_quest31),
  QF_QUEST32 =
      (1U << tk_quest32), // Unused; BUG: Broken Coupling accidentally sets it.
