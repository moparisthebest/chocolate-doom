...
const char *sprnames[NUMSPRITES + 1] = {
    "PLAY", "PNCH", "WAVE", "RBPY", "TRGT", "XBOW", "MMIS", "RIFG", "RIFF",
    "FLMT", "FLMF", "BLST", "BLSF", "GREN", "GREF", "SIGH", "SIGF", "POW1",
    "POW2", "POW3", "ZAP1", "SPRY", "BLOD", "PUFY", "SHT1", "SHT2", "GRIN",
    "GRAP", "UBAM", "BNG2", "BNG4", "BNG3", "FLBE", "XPRK", "OCLW", "CCLW",
    "TEND", "MICR", "MISS", "AROW", "ARWP", "TORP", "THIT", "TWAV", "MISL",
    "TFOG", "IFOG", "SHRD", "RGIB", "MRYS", "MRNO", "MRST", "MRLK", "MRBD",
    "MRPN", "MRGT", "BURN", "DISR", "PEAS", "GIBS", "AGRD", "ARMR", "SACR",
    "TNK1", "TNK2", "TNK3", "TNK4", "TNK5", "TNK6", "NEAL", "BEGR", "HMN1",
    "LEDR", "LEAD", "ROB1", "PGRD", "ROB2", "MLDR", "ORCL", "PRST", "PDED",
    "ALN1", "AL1P", "NODE", "MTHD", "MNAM", "MNAL", "MDTH", "NEST", "PODD",
    "ZAP6", "ZOT3", "ZAP7", "ZOT1", "ZAP5", "ZOT2", "SEWR", "SPID", "ROB3",
    "RBB3", "PRGR", "BASE", "FRBL", "KLAX", "TURT", "BALL", "PSTN", "SECR",
    "TARG", "RING", "EARS", "COMM", "BOOM", "RATT", "HOGN", "DEAD", "SBAN",
    "BOTR", "HATR", "TOPR", "COUP", "BUBB", "BUBF", "BUBC", "ASPR", "SPDL",
    "TOKN", "OTOK", "HELT", "GUNT", "FULL", "MEAT", "JUNK", "FFOT", "DIE1",
    "BEAC", "ARM1", "ARM2", "BARW", "BART", "LAMP", "LANT", "BARL", "BOWL",
    "BRAZ", "TRCH", "LTRH", "LMPC", "LOGS", "TRHO", "WATR", "MUGG", "FUSL",
    "CRD1", "CRD2", "TPAS", "KY1G", "KY2S", "KY3B", "HAND", "CRYS", "PRIS",
    "PWR1", "PWR2", "PWR3", "ORAC", "GYID", "FUBR", "WARE", "RCRY", "BCRY",
    "CHAP", "TUNL", "BLTK", "SECK", "MINE", "REBL", "PROC", "ANKH", "GOID",
    "STMP", "MDKT", "COIN", "CRED", "SACK", "CHST", "SHD1", "MASK", "UNIF",
    "OFIC", "PMAP", "PMUP", "BLIT", "BBOX", "MSSL", "ROKT", "BRY1", "CPAC",
    "PQRL", "XQRL", "GRN1", "GRN2", "BKPK", "RELC", "RIFL", "FLAM", "BFLM",
    "MMSL", "TRPD", "GRND", "CBOW", "SIGL", "LITE", "CNDL", "CLBR", "LITS",
    "LITB", "LITG", "ROK1", "ROK2", "ROK3", "ROK4", "LOGG", "RUB1", "RUB2",
    "RUB3", "RUB4", "RUB5", "RUB6", "RUB7", "RUB8", "CHAN", "STAT", "DSTA",
    "CRAB", "CAGE", "TREE", "TRE1", "BUSH", "SHRB", "STAK", "BAR1", "VASE",
    "STOL", "POT1", "TUB1", "ANVL", "TLMP", "TRAY", "APOW", "AFED", "DRIP",
    "CDRP", "SPLH", "WTFT", "HERT", "TELP", "MONI", "STEL", "STLA", "STLE",
    "HUGE", "STLG", NULL};
...
state_t states[NUMSTATES] = {
    ...
    /*S_MNAL_38*/
    {SPR_MNAL, 32788, 4, {A_FireSigilEOffshoot}, S_MNAL_39},           // 940
    ...
    /*S_SEWR_05*/
    {SPR_SEWR, 32770, 4, {A_CheckTargetVisible}, S_SEWR_04},             // 1000
    ...
    /*S_HOGN_00*/
    {SPR_HOGN, 0, 2, {A_ZombieInSpecialSector}, S_HOGN_00}, // 1223
    /*S_HOGN_01*/
    {SPR_HOGN, 1, 1, {A_ZombieInSpecialSector}, S_HOGN_02},           // 1224
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
...

    {
        ...
        MF_SOLID | MF_SHOOTABLE | MF_NOTDMATCH | MF_COLORSWAP1 |
            MF_COLORSWAP3, // flags
...

    {
        ...
        0,             // damage
        sfx_None,      // activesound
        MF_SOLID | MF_SHOOTABLE | MF_NOTDMATCH | MF_COLORSWAP2 |
            MF_COLORSWAP3, // flags
        "Armorer",         // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_rebact,    // activesound
        MF_SOLID | MF_SHOOTABLE | MF_JUSTHIT | MF_COUNTKILL |
            MF_COLORSWAP1, // flags
        NULL,              // namepointer
    },
...

    {
        ...
        MF_SOLID | MF_SHOOTABLE | MF_NODIALOG | MF_NOBLOOD |
            MF_COUNTKILL, // flags
        NULL,             // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_rebact,    // activesound
        MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_NOTDMATCH |
            MF_SPECTRAL, // flags
        "MACIL",         // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_agrac1,    // activesound
        MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_COLORSWAP1 |
            MF_COLORSWAP2, // flags
        "ACOLYTE",         // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_agrac3,    // activesound
        MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL | MF_COLORSWAP2 |
            MF_COLORSWAP3, // flags
        "ACOLYTE",         // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_None,      // activesound
        MF_SOLID | MF_SHOOTABLE | MF_NOBLOOD | MF_COUNTKILL |
            MF_NOTDMATCH, // flags
        "ORACLE",         // namepointer
    },
...

    {
        ...
        MF_SOLID | MF_SHOOTABLE | MF_SPAWNCEILING | MF_NOGRAVITY |
            MF_GIVEQUEST | MF_FLOAT | MF_NODIALOG | MF_NOBLOOD |
            MF_COUNTKILL, // flags
        NULL,             // namepointer
    },
...

    {
        ...
        MF_SOLID | MF_SHOOTABLE | MF_DROPOFF | MF_NOBLOOD |
            MF_COUNTKILL, // flags
        NULL,             // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_None,      // activesound
        MF_SOLID | MF_SHOOTABLE | MF_GIVEQUEST | MF_NODIALOG |
            MF_NOBLOOD, // flags
        NULL,           // namepointer
    },
...

    {
        ...
        0,             // damage
        sfx_None,      // activesound
        MF_SPECIAL | MF_SOLID | MF_SHOOTABLE | MF_NODIALOG |
            MF_NOBLOOD, // flags
...

    {
        ...
        MF_SOLID | MF_SHOOTABLE | MF_NOGRAVITY | MF_GIVEQUEST |
            MF_NOBLOOD, // flags
        NULL,           // namepointer
    },
