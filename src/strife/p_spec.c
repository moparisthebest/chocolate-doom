...
//
animdef_t animdefs[] = {
    {false, "F_SCANR8", "F_SCANR5", 4},  {false, "F_WATR03", "F_WATR01", 8},
    {false, "F_PWATR3", "F_PWATR1", 11}, {false, "F_SCANR4", "F_SCANR1", 4},
    {true, "SCAN08", "SCAN05", 4},       {true, "SWTRMG03", "SWTRMG01", 4},
    {true, "SCAN04", "SCAN01", 4},       {true, "COMP04", "COMP01", 4},
    {true, "COMP08", "COMP05", 6},       {true, "COMP12", "COMP09", 11},
    {true, "COMP16", "COMP13", 12},      {true, "COMP20", "COMP17", 12},
    {true, "COMP24", "COMP21", 12},      {true, "COMP28", "COMP25", 12},
    {true, "COMP32", "COMP29", 12},      {true, "COMP37", "COMP33", 12},
    {true, "COMP41", "COMP38", 12},      {true, "COMP49", "COMP42", 10},
    {true, "BRKGRY16", "BRKGRY13", 10},  {true, "BRNSCN04", "BRNSCN01", 10},
    {true, "CONCRT12", "CONCRT09", 11},  {true, "CONCRT25", "CONCRT22", 11},
    {true, "WALPMP02", "WALPMP01", 16},  {true, "WALTEK17", "WALTEK16", 8},
    {true, "FORCE04", "FORCE01", 4},     {true, "FORCE08", "FORCE05", 4},
    {true, "FAN02", "FAN01", 4},         {false, "F_VWATR3", "P_VWATR1", 4},
    {false, "F_HWATR3", "F_HWATR1", 4},  {false, "F_TELE2", "F_TELE1", 4},
    {false, "F_FAN2", "F_FAN1", 4},      {false, "F_CONVY2", "F_CONVY1", 4},
    {false, "F_RDALN4", "F_RDALN1", 4},  {-1, "", "", 0},
};
...
terraintype_t terraintypes[] = {
    {"F_WATR03", FLOOR_WATER, -1}, {"F_WATR02", FLOOR_WATER, -1},
    {"F_WATR01", FLOOR_WATER, -1}, {"F_VWATR3", FLOOR_WATER, -1},
    {"F_VWATR2", FLOOR_WATER, -1}, {"P_VWATR1", FLOOR_WATER, -1},
    {"F_HWATR3", FLOOR_WATER, -1}, {"F_HWATR2", FLOOR_WATER, -1},
    {"F_HWATR1", FLOOR_WATER, -1}, {"F_PWATR3", FLOOR_SLIME, -1},
    {"F_PWATR2", FLOOR_SLIME, -1}, {"F_PWATR1", FLOOR_SLIME, -1},
    {"END", FLOOR_END, -1},
};
...
terraintype_e P_GetTerrainType(mobj_t *mobj) {
  ...
  if (mobj->z <= ss->sector->floorheight && terraintypes[0].type != FLOOR_END) {
...
void P_CrossSpecialLine(int linenum, int side, mobj_t *thing) {
  ...
  case 215:
    // haleyjd 09/21/10: [STRIFE] W1 Voiced Objective if Quest (Tag/100,
    // Tag%100) must be player 1...
    if (thing->player != &players[0])
      break;
  ...
  case 126:
    // TELEPORT MonsterONLY. - [STRIFE] Verified unmodified (except for 0 flags
    // param)
    if (!thing->player)
      EV_Teleport(line, side, thing, TF_NORMAL);
    break;
  ...
  case 145:
    ...
    thing->momx = thing->momy = thing->momz = 0;
    {
      ...
      DEH_snprintf(crosslinestr, sizeof(crosslinestr), "Entering%s",
                   DEH_String(mapnames[map - 1]) + 8);
      thing->player->message = crosslinestr;

      if (netgame && deathmatch) {
        if (levelTimer && levelTimeCount != 0) {
          DEH_snprintf(crosslinestr, sizeof(crosslinestr), "%d min left",
