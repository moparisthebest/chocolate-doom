...
{
    char tagName[32];
    char lumpname[12];          // Only need 9 bytes, but padded out to be dword
aligned
    ...
    void *snd_ptr;
    int lumpnum;
    int numchannels;            // total number of channels a sound type may
occupy boolean changePitch; } sfxinfo_t;
*/
